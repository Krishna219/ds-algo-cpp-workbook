...
## DP Problem 
We must define *Best(i)* must contain length of longest fully dividing subsequence that ends at index i. Meaning the susbsequence must include *ai* and use only elements from first *i* positions.
